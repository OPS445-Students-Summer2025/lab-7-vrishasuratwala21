...
class Time:
    ...
    def __repr__(self):
        """String representation for the object in interactive shell"""
        return f'{self.hour:02d}.{self.minute:02d}.{self.second:02d}'
    ...
    def sum_times(self, t2):
        """Add this time object to another and return a new Time object"""
        total_seconds = self.time_to_sec() + t2.time_to_sec()
        return sec_to_time(total_seconds)

    def change_time(self, seconds):
        """Add or subtract seconds from the current time object"""
    ...
    def time_to_sec(self):
        """Convert the time object to a single integer in seconds"""
